...
<template>
  <div class="error-page">
    <div class="robotpage-top-half">
      <img src="https://s3-eu-west-1.amazonaws.com/thriva-dev/logo.png" alt="thriva" />
      <div id="robot_holder">
    ...
    <div class="robotpage-bottom-half">
      ...
      <div>
        ...
        <p>Why don't you head back to your dashboard and try again?</p>
        <div class="robot-buttons">
          <a class="robot-buttons" href="https://app.thriva.co/dashboard">Dashboard</a>
        </div>
      </div>
